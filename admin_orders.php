...
if(isset($_POST['update_order'])){
   ...
   $message[] = 'Статус оплаты был изменен!';
...
<section class="orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Добавленные товары : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
      ...
      <?php
         ...
         echo '<p class="empty">Пока что пользователи ничего не заказывали!</p>';
      }
      ?>
   </div>
